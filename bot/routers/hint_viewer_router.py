...
hint_viewer_router.message.middleware(LimitedUsersMiddleware(max_users=1))
hint_viewer_router.callback_query.middleware(LimitedUsersMiddleware(max_users=1))
