...
keyboard-user-reply-match_analysis_cabinet = 🎧 Анализ матча
...
pokaz-page-jacobi = Якоби
pokaz-page-beaver = Бивер
pokaz-page-max-cube-short = Макс куб
pokaz-page-yes = Да
pokaz-page-no = Нет
...
pokaz-page-match-to = Матч до __LENGTH__. Счет __MAX__-__MIN__
pokaz-page-table-header-move = Ход
pokaz-page-table-header-equity = Эквити
pokaz-page-table-header-action = Действие
pokaz-page-impossible-move = невозможный ход
pokaz-page-unknown-hint-type = Неизвестный тип подсказки
pokaz-page-turn-white = Ход белых
pokaz-page-turn-black = Ход черных
pokaz-page-loading-hints = Поиск лучших ходов
