...
class KeyboardUserReply:
    ...
    @staticmethod
    def cards_cabinet() -> Literal["""🗂️ Cards"""]: ...
    @staticmethod
    def match_analysis_cabinet() -> Literal["""🎧 Match analysis"""]: ...
    @staticmethod
    def pip_count_cabinet() -> Literal["""🧮 Pip count"""]: ...
...
class ProAnalysis:
    ...
    @staticmethod
    def order_sent() -> Literal["""✅ Request sent to an expert, the reply will be in this chat."""]: ...
    @staticmethod
    ...
    @staticmethod
    def admin_send_to_analysis() -> Literal["""Send for analysis"""]: ...
    @staticmethod
    def admin_no_document() -> Literal["""❌ No match file in this message"""]: ...
    @staticmethod
    def admin_analyze_forbidden() -> Literal["""Admins only"""]: ...
    @staticmethod
