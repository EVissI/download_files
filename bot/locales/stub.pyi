...
class AutoBatch:
    ...
    @staticmethod
    def summary_pr_header(*, count: PossibleValue, date: PossibleValue, time: PossibleValue) -> Literal["""Game Analysis. Average PR from { $count } matches, Analysis time: { $time }. Date: { $date }."""]: ...
    @staticmethod
